...
A unit test involves testing a "unit" of code for its behavior isolated from everything else; a unit can be a class or a method, or a module &mdash; the definition is up to you.
